...
class HelpDialog(QDialog):
    MANUAL_HTML = """
    <h2 style="color:#89b4fa;">Manual de Usuario</h2>
    <hr style="border-color:#2a2a40;"/>
    <h3 style="color:#89dceb;">Ingreso de datos</h3>
    <p><b>Ecuaciones en texto libre:</b></p>
    <ul>
      <li><code>2x + y - z = 8</code></li>
      <li><code>(1/2)x + y - z = 1</code></li>
      <li><code>0.5x - y + z = 3</code></li>
      <li><code>-x + 3y = -4</code></li>
    </ul>
    <p><b>Matriz directa:</b> llena las celdas [A|b] (columna dorada = termino independiente).</p>
    <h3 style="color:#89dceb;">Interpretar pasos</h3>
    <ul>
      <li><span style="color:#a6e3a1;">Verde</span> = fila pivote</li>
      <li><span style="color:#f38ba8;">Rojo</span> = fila modificada</li>
      <li><span style="color:#f9e2af;">Amarillo</span> = filas intercambiadas</li>
    </ul>
